...
PWD="${PWD_THIS}/../../../.."
PWD_APP_NODE_EXPRESS="${PWD}/packages/app-node-express"
PWD_MONGODB_TOOLS_BIN="${PWD}/packages/app-node-express/tools/mongodb-database-tools/bin"
