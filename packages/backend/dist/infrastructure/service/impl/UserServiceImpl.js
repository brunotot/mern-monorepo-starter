...
let UserServiceImpl = (() => {
    ...
    var UserServiceImpl = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "UserServiceImpl");
    (() => {
        ...
        UserServiceImpl = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UserServiceImpl = _classThis;
})();
