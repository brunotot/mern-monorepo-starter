...
export function PageableResponseDto(schema) {
...
export const UserContract = initContract().router({
  findOne: {
    ...
    responses: Object.assign(
      { 200: User, 404: ZOD_ERROR_ANY.describe("User not found") },
      defaultResponses,
    ),
  },
  pagination: {
    ...
    responses: Object.assign({ 200: UserPageableResponseDto }, defaultResponses),
  },
  create: {
    metadata,
    strictStatusCodes: true,
    ...
    body: User,
    responses: Object.assign({ 201: User }, defaultResponses),
  },
});
